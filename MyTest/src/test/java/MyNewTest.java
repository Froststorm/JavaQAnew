...
public class MyNewTest {
    ...
    List<String> myсoolList = new ArrayList<String>(Arrays.asList("//li[1]/a/span",
    ...
    public void MyTestMethod1() {
        ...
        for (int i = 0; i < myсoolList.size(); i++) {
            long startTime = System.currentTimeMillis() / 1000;
            System.out.println(" The start time is : " + startTime);
            if (i == 0 || i == 8) {
                driver.findElement(By.xpath(myсoolList.get(i))).click();
...
//            System.out.println(" The end time is : " + endTime);
            ...
            System.out.println(myсoolList.get(i) + " Pass :" + i);
        }
    }
